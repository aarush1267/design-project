    ...
    .search-box:focus-within > .search-btn:hover {
      border: 2px solid black;
        ...
        <th width="20%">
          ...
          <img onclick="location.href='catalogues.php'"src="img/cataloguesorange.png" style="width:90px; margin-left:757px; margin-bottom:10px; margin-top:-10px; cursor: pointer">
