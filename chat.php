    ...
    .search-box:focus-within > .search-btn:hover {
      border: 2px solid black;
        ...
        <th width="20%">
          ...
          <img onclick="location.href='chat.php'"src="img/orangechat.png" style="width:80px; margin-left:40px; margin-bottom:17px; margin-top:-35px; cursor: pointer">
        </tr>
      </table>
